    ...
    options: [
      {
        id: "new-matches",
        label: "New matches",
        description: "Get notified about new potential matches",
      },
      {
        id: "messages",
        label: "Messages",
...
export default function PreferencesSetupStep({
          ...
          <View style={styles.rangeInput}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                const newValue = {
                  ...value,
                  min: Math.min(value.max - 1, value.min + 1),
                };
                updatePreference(section.id, newValue);
              }}
            >
          ...
          <View style={styles.rangeInput}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                const newValue = {
                  ...value,
                  max: Math.max(value.min + 1, value.max - 1),
                };
                updatePreference(section.id, newValue);
              }}
            >
  ...
  const renderMultiSelect = (section: PreferenceSection) => {
    const selectedValues =
      preferences[section.id] || section.defaultValue || [];
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>
            Help us find better matches by setting your preferences. You can
